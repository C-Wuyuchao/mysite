...
class ChangePasswordForm(forms.Form):
    ...
    new_password_agin = forms.CharField(label='再次输入新密码',
    ...
    def clean(self):
        ...
        new_password_agin = self.cleaned_data['new_password_agin']
        if new_password != new_password_agin or new_password_agin == '':
