...
from .forms import LoginForm, RegForm, ChangeNicknameForm, BindEmailForm, ChangePasswordForm, FindPasswordForm
...
def find_password(request):
    ...
    if request.method == 'POST':
        form = FindPasswordForm(request.POST, request=request)
        if form.is_valid():
            email = form.cleaned_data['email']
